...
if __name__ == "__main__":
    ...
    #print functions.get_parameter_col_names_station(None, 'RMPW12', 'daily')
    #print functions.get_stations_parameters(None, 'RMPW12', 'daily')
    #print functions.get_parameter_col_names_station_from_scm(None, 'RMPW12')
    print functions.make_station_parameter_lookup_minutes()